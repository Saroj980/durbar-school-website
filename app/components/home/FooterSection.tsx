      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10 border-b border-white/10 pb-12">
        ...
        <div>
          ...
          <p className="text-neutralLight/80 text-sm leading-relaxed font-body max-w-xs">
            Nepal’s modern educational institution — fostering academic excellence
            and character since 2070.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-neutralLight/80 text-sm font-body">
            <li>Dhangadhi, Nepal</li>
            <li>Phone: +977-1-5551234</li>
            <li>Email: info@durbarschool.edu.np</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex space-x-4">
            {[
              ...
              { icon: Mail, href: "mailto:info@durbarschool.edu.np" },
              ...
              <Link
                ...
                className="w-10 h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-secondary text-neutralLight hover:text-neutralDark transition-all duration-300"
              >
